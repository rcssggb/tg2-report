...
\begin{tabular}{c}
	...
	\begin{lstlisting}[caption={Pseudo-código que descreve a rotina de treinamento} , captionpos=b]
...
A seguir, são descritos os algoritmos dos comportamentos de forma geral. Com poucas adaptações chega-se aos comportamentos específicos para direita ou esquerda do campo.
	...
	\begin{tabular}{c}
		\label{code:walktoball}
		\begin{lstlisting}[caption={Algoritmo do comportamento de se aproximar da bola} , captionpos=b]
	...
	\begin{tabular}{c}
		\label{code:leadball}
		\begin{lstlisting}[caption={Algoritmo geral do comportamento de carregar bola} , captionpos=b]
	...
	\begin{tabular}{c}
		\label{code:shootball}
		\begin{lstlisting}[caption={Algoritmo geral do comportamento de chutar bola para o gol} , captionpos=b]
			fun'ç''ã'o CarregarBola(s):
