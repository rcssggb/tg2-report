...
Nos Algoritmos \ref{code:walktoball}, \ref{code:leadball} e \ref{code:shootball} são descritos os algoritmos dos comportamentos de forma geral. Com poucas adaptações chega-se aos comportamentos específicos para direita ou esquerda do campo.
