...
\begin{itemize}
	\item \textbf{Coordenada X}: normalizada de acordo com o comprimento do campo.
	\item \textbf{Coordenada Y}: normalizada de acordo com a largura do campo.
	\item \textbf{Orientação}: normalizada em relação a $180º$.
	\item \textbf{Distância para a bola}: normalizada em relação à distância máxima visível.
	\item \textbf{Direção da bola}: normalizada em relação a $180º$. 
