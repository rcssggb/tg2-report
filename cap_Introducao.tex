...
\par Deseja-se, então, explorar o problema de se fazer gols, com um agente único, no ambiente descrito por meio de técnicas de aprendizagem por reforço.
