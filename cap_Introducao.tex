...
O treinamento de agentes, sejam eles máquinas físicas ou simuladas, para realizar certas tarefas é um campo de estudo crescente em meio a academia e setor privado. Em um ambiente de robôs jogadores de futebol simulados, este trabalho tem como alvo estruturar o procedimento de treinamento desses jogadores autônomos.
...
\par Deseja-se, então, explorar o problema de se fazer gols com um agente único no ambiente descrito utilizando-se de técnicas de aprendizagem por reforço. Para isso, foi desenvolvida uma biblioteca de interfaceamento com o servidor da partida como adaptação do ambiente. Após isso, o agente foi treinado com a utilização de técnicas de RL em duas abordagens - ações puras e comportamentos - de forma a compará-las.
