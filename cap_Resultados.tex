...
O gráfico da Figura \ref{fig:single-agent-sarsa-behaviors} mostra em conjunto o retorno a cada treino de partida e a média móvel do retorno com janela de 1000 treinamentos de  partidas. É possível observar que há um tendência de subida do retorno com o passar dos episódios experienciados. Porém, em grande parte dos treinos de partida, o agente não realizou nenhum gol, refletido pelo baixo valor da média de 1000 treinos de partida, que precisou ser multiplicado por 10 para melhor visualização gráfica.
