...
\par A aprendizagem com diferença temporal (\textit{temporal-difference learning}, ou TD) é uma das ideias centrais de RL \cite{sutton2018reinforcement}. Esse tipo de aprendizado é importante pois permite o aprendizado sem um modelo prévio do MDP do ambiente e também permite que se atualize estimativas das funções de valor utilizando outras estimativas, conhecido como \textit{bootstrapping}, acelerando dramaticamente o tempo de treinamento, por ser possível treinar a cada ciclo.  
